...
class Blockchain:
    ...
    def add_transaction(self, recipient, sender, signature, amount=2.0, is_receiving=False):
        """ Append a new value as well as the last blockchain value to the blockchain.

        Arguments:
            :sender: The sender of the coins.
            :recipient: The recipient of the coins.
            :amount: The amount of coins sent with the transaction (default = 2.0)
        """
        # transaction = {
        #     'sender': sender,
        #     'recipient': recipient,
    ...
    def get_peer_nodes(self):
        """Reeturn a list of all connected peer nodes."""
